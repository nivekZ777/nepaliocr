/*
 * Original code was forked from : http://code.google.com/p/nepaliocr/source/browse/trunk/Resegment.cpp?spec=svn146&r=138 and 
 * http://code.google.com/p/nepaliocr/source/browse/trunk/Resegment.h?spec=svn146&r=138
 */
...
namespace NOCR
{
    public class Resegment
    {
        ...
        internal Resegment(Bitmap im, bool BinaryDone, bool ImageLoaded, bool SeparateDone, bool[,] BinArray, int numberOfLines, Line[] Lines, Graphics gg, int totalUnits, int SizeThreshold, int flevel, int[,] headbottom)
        {
            this.img = im;
        ...
        public void getPixelInRows(int height, int width, bool[,] bArray)
        {
        ...
        int MultiFactorialAnalysis(int Headline_Pos, int Bottom_Pos)
        {
            int i, j;
