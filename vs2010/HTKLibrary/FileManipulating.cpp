/*
* Original Code was forked from : http://code.google.com/p/nepaliocr/source/browse/trunk/FileManipulating.cpp?spec=svn146&r=108
*/
...
void FileManipulating::PrepareData(System::String* dataFileName,  int imageArr __gc [,], int leftX, int rightX, int topY, int bottomY)
{
	try{
