...
public __gc class myWindowSeparate
{
private:
	bool **BinaryArray;
...
public:
	myWindowSeparate(Bitmap* im,bool **B,Graphics* gr);
	Line *Lines;
	void LineSeparate();
...
myWindowSeparate::myWindowSeparate(Bitmap* im,bool **B,Graphics* gr)
{
	this->xSize=im->Width;
...
void myWindowSeparate::LineSeparate()
{
...
void myWindowSeparate::WordSeparate(ArrayList* start,ArrayList* end)
{
...
void myWindowSeparate::drawHorizontalHist()
{
	Pen* p=new Pen(Color::Red,1);
...
void myWindowSeparate::WordSeparate1(ArrayList* start,ArrayList* end)
{
	ArrayList** wordStart=new ArrayList*();
	ArrayList** wordEnd=new ArrayList*();
	IEnumerator *wordStartEnumerator,*wordEndEnumerator;
...
void myWindowSeparate::CheckMattra(ArrayList* lineStart,ArrayList* lineEnd,ArrayList** wordStart,ArrayList** wordEnd)
{
...
void myWindowSeparate::CharSeparate(ArrayList* start,ArrayList* end,ArrayList** wStart,ArrayList** wEnd)
{
	//ArrayList*** wordStart=new ArrayList*();
	//ArrayList** wordEnd=new ArrayList*();
	//ArrayList** wordStart1=new ArrayList*();
...
int myWindowSeparate::getNumberOfLines()
{
	return this->numberOfLines;
}

Line* myWindowSeparate::getLines()
{
	return this->Lines;
}
